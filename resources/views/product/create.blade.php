...
<html lang="{{ str_replace('_', '-', app()->getLocale()) }}">
    ...
    @csrf
        ...
        <div class="form-group row mt-4">
            ...
            <div class="col-md-9"> 
                <input type="text" name="name" id="name" placeholder="Enter Name" class="form-control" autocomplete="off" autofocus="true" value="{{ old('name') }}" >                
                @error('name')
        ...
        <div class="form-group row mt-4">
                ...
                <div class="col-md-9"> 
                    <input type="file" name="src" id="src" class="form-control" autocomplete="off" value="{{ old('src') }}">                  
                    @error('src')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
            ...
            <div class="form-group row mt-4">
                ...
                <div class="col-md-9"> 
                    <input type="text" name="amount" id="amount" value="{{ old('amount') }}" class="form-control" autocomplete="off">                  
                    @error('amount')
                        <div class="alert alert-danger">{{ $message }}</div>
                    @enderror
                </div>
